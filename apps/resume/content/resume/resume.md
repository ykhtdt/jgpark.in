...
스타트업 환경에서 비즈니스 우선순위와 일정에 맞춰 빠르게 개발하면서도, 향후 <strong>확장과 개선이 가능한 코드 구조를 설계</strong>합니다.<br />
...
- 일본 군마 현청에서 경찰이 PDA 통해 업무를 수행할 수 있도록 지원하는 시스템인 GP-WAN 프로젝트의 교통계 방치주차위반 관리 기능 개발

    ...
    <div className="flex justify-between">
      ...
      <ul className="flex flex-col space-y-px text-sm">
        <li className="flex items-center gap-2">
          ...
          <a href={`mailto:${frontmatter.email}`} className="text-muted-foreground">
            {frontmatter.email}
          </a>
        </li>
        <li className="flex items-center gap-2">
          ...
          <a href={frontmatter.github} target="_blank" rel="noopener noreferrer" className="text-muted-foreground">
            {frontmatter.github}
          </a>
        </li>
      </ul>
